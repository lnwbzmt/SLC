...
import br.com.xkinfo.slc.util.tableModel.PessoaUCTableModel;
import br.com.xkinfo.slc.view.cadastro.CadastroPessoaUC;
...
public class ConsultaPessoaUC extends javax.swing.JDialog {

    private Usuario usuarioLogado;

    public ConsultaPessoaUC(java.awt.Frame parent, boolean modal, Usuario usuario) {
        super(parent, modal);
        ...
        ListSelectionModel linhaModeloSelecao = jtPessoaUCs.getSelectionModel();
        linhaModeloSelecao.addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if (jtPessoaUCs.getSelectedRow() >= 0) {

                    Integer linhaSelecionada = jtPessoaUCs.getSelectedRow();
 ...
 //                       cadastroPessoaUC.setVisible(true);
    ...
    private void initComponents() {
        ...
        jtPessoaUCs = new javax.swing.JTable();
        ...
        jtPessoaUCs.setModel(new PessoaUCTableModel());
        jtPessoaUCs.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jScrollPane1.setViewportView(jtPessoaUCs);
...
//        cadastroPessoaUC.setVisible(true);
    ...
    private void formWindowActivated(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowActivated
        jtPessoaUCs.updateUI();
        jtPessoaUCs.getRowHeight(0);
        jtPessoaUCs.setModel(new PessoaUCTableModel());
    ...
    private void txtFiltroKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtFiltroKeyReleased
        ...
        PessoaUCTableModel model = (PessoaUCTableModel) jtPessoaUCs.getModel();
        sorter = new TableRowSorter<TableModel>(model);
        jtPessoaUCs.setRowSorter(sorter);
    ...
    private javax.swing.JTable jtPessoaUCs;
