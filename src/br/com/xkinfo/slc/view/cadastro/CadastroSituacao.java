...
public class CadastroSituacao extends javax.swing.JDialog {
    ...
    public CadastroSituacao(Situacao situacao, java.awt.Frame parent, boolean modal,Usuario usuario) {
        ...
        this.situacaoSelecionado = situacao;
        if (situacaoSelecionado != null) {
            tfCodigo.setText(situacao.getId().toString());
            //tfNome.setText(situacao.getFatura().toString());
    ...
    private void bSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSalvarActionPerformed
        if (situacaoSelecionado != null) {
            //situacaoSelecionado.setSituacao(Date.valueOf(tfNome.getText()));
            try {
                //ServiceFactory.getSituacaoService().alterarSituacao(situacaoSelecionado);
                JOptionPane.showMessageDialog(this, "Situacao Alterado com Sucesso!");

            } catch (Exception ex) {
                Logger.getLogger(CadastroSituacao.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            //Situacao situacao = new Situacao(null,null,null,null,null,0,null,tfNome.getText(),0,null,null);
            try {
                
                //ServiceFactory.getSituacaoService().incluirSituacao(situacao);
                JOptionPane.showMessageDialog(this, "Situacao Inlcuído com Sucesso!");
            } catch (Exception ex) {
                Logger.getLogger(CadastroSituacao.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void bExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bExcluirActionPerformed
        if (situacaoSelecionado != null) {
            try {
                //ServiceFactory.getSituacaoService().excluirSituacao(situacaoSelecionado);
                JOptionPane.showMessageDialog(this, "Situacao Excluído com Sucesso!");
            } catch (Exception ex) {
                Logger.getLogger(CadastroSituacao.class.getName()).log(Level.SEVERE, null, ex);
            }
            situacaoSelecionado = null;
