...
public class CadastroPessoaUC extends javax.swing.JDialog {
    ...
    private PessoaUc pessoaUcSelecionado;
    ...
    public CadastroPessoaUC(PessoaUc pessoaUc, java.awt.Frame parent, boolean modal,Usuario usuario) {
        this(parent, modal,usuario);
        this.pessoaUcSelecionado = pessoaUc;
        if (pessoaUcSelecionado != null) {
            tfCodigo.setText(pessoaUc.getId().toString());
            //tfNome.setText(pessoaUc.getFatura().toString());
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Dados de PessoasUC"));
