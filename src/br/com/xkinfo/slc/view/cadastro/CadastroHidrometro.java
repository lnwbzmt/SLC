...
public class CadastroHidrometro extends javax.swing.JDialog {
    ...
    public CadastroHidrometro(Hidrometro hidrometro, java.awt.Frame parent, boolean modal,Usuario usuario) {
        ...
        this.hidrometroSelecionado = hidrometro;
        if (hidrometroSelecionado != null) {
            tfCodigo.setText(hidrometro.getId().toString());
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(jdDataRecebimento, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void bSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bSalvarActionPerformed
        if (hidrometroSelecionado != null) {
            //hidrometroSelecionado.setHidrometro(Date.valueOf(tfNome.getText()));
            try {
                //ServiceFactory.getHidrometroService().alterarHidrometro(hidrometroSelecionado);
                JOptionPane.showMessageDialog(this, "Hidrometro Alterado com Sucesso!");

            } catch (Exception ex) {
                Logger.getLogger(CadastroHidrometro.class.getName()).log(Level.SEVERE, null, ex);
            }
        } else {
            //Hidrometro hidrometro = new Hidrometro(null,null,null,null,null,0,null,tfNome.getText(),0,null,null);
            try {
                
                //ServiceFactory.getHidrometroService().incluirHidrometro(hidrometro);
                JOptionPane.showMessageDialog(this, "Hidrometro Inlcuído com Sucesso!");
            } catch (Exception ex) {
                Logger.getLogger(CadastroHidrometro.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    ...
    private void bExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bExcluirActionPerformed
        if (hidrometroSelecionado != null) {
            try {
                //ServiceFactory.getHidrometroService().excluirHidrometro(hidrometroSelecionado);
                JOptionPane.showMessageDialog(this, "Hidrometro Excluído com Sucesso!");
            } catch (Exception ex) {
                Logger.getLogger(CadastroHidrometro.class.getName()).log(Level.SEVERE, null, ex);
            }
            hidrometroSelecionado = null;
